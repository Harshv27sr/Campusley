    ...
    <AuthLayout title="Welcome back 👋" subtitle="Log in to continue your learning journey">
      <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
        ...
        <button
          type="button"
          disabled
          className="w-full flex items-center justify-center gap-3 px-5 py-3 rounded-xl border-2 border-slate-200 dark:border-slate-700 text-slate-400 dark:text-slate-500 font-semibold text-sm cursor-not-allowed opacity-60"
        ...
        >
          ...
          Continue with Google <span className="text-xs ml-1 px-1.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-400">Coming Soon</span>
        </button>
